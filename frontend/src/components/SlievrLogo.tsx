    ...
    >
      <defs>
        <linearGradient id={gradientId} x1="0%" y1="0%" x2="100%" y2="100%">
          ...
          <stop offset="25%" stopColor="var(--color-spring-green)">
            <animate
              attributeName="offset"
          ...
          <stop offset="50%" stopColor="var(--color-salmon)">
            <animate
              attributeName="offset"
              values="0.5;1.5;0.5"
              dur="3s"
          ...
          <stop offset="75%" stopColor="var(--color-tufts-blue)">
            <animate
              attributeName="offset"
          ...
          <stop offset="100%" stopColor="var(--color-spring-green)">
            <animate
              attributeName="offset"
              values="1;2;1"
              dur="3s"
